    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.infoBox}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoText}>{issue.images} images captured</Text>
        </View>
      </View>
      ...
      <View style={styles.imageGrid}>
        {[...Array(issue.images)].map((_, index) => (
          <View key={index} style={styles.imageCard}>
            ...
            <Text style={styles.imageText}>CCTV Frame {index + 1}</Text>
          </View>
        ))}
      </View>
      ...
      <View style={styles.uploadBox}>
        ...
        <Text style={styles.uploadText}>Upload additional images</Text>
      </View>
      ...
      {issue.status === "Critical" && (
        <View style={styles.warning}>
          ...
          <View style={{ marginLeft: 8 }}>
            <Text style={styles.warningTitle}>Critical Issue</Text>
            <Text style={styles.warningText}>
              This issue has been flagged as critical and requires immediate
              attention from {issue.department}.
            </Text>
          </View>
        </View>
      )}
